...
$$\sum_{k=0}^{n-1} \frac{ P_{2k}(x) e^{-V(x)} \frac{\mathrm{d}}{\mathrm{d}y}\left( P_{2k+1}(y) e^{-V(y)} \right) - P_{2k+1}(x) e^{-V(x)} \frac{\mathrm{d}}{\mathrm{d}y}\left( P_{2k}(y) e^{-V(y)} \right)}{2 h_k} $$
